...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gpio_defines.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gpio_top.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module gpio_top">>raptor_tcl.tcl 
