...
#creating a tcl file to run raptor flow 
    ...
    echo "target_device GEMINI_COMPACT_104x68">>raptor_tcl.tcl 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/spi.svh">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/clk_gate_beh.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/pulse_sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/spim_intf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/spim_reg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/spim_reg_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/spim_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/spimavb.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/levelsync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/asyncfifo.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/syncfifo.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/syncfifo_mem1r1w.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/syncfifo_ram.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/syncfifo_reg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spim/rst_regen_low.sv">>raptor_tcl.tcl
    ##vary design to design
