...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_include_path ./rtl/aes_rcon/">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_library_path ./rtl/aes_rcon/">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_library_ext .v .sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_cipher_top.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_key_expand_128.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_rcon.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_sbox.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gcm_aes_v0.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gfm128_16.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module gcm_aes_v0">>raptor_tcl.tcl 
