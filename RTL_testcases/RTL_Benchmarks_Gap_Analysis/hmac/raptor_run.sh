...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_subreg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_util_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/pwrmgr_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/pwrmgr_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_ram_1p_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_mubi_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_cipher_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_alert_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_count_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/jtag_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/entropy_src_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/edn_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/top_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/flash_ctrl_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/flash_ctrl_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/flash_phy_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/hmac_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/hmac_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/lc_ctrl_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/otp_ctrl_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/otp_ctrl_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ast_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/hmac.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/hmac_core.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/hmac_reg_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_alert_sender.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_diff_decode.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_fifo_sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_flop_2sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_flop.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_flop_2sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_intr_hw.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_packer.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_inv_39_32_dec.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_inv_39_32_enc.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_inv_64_57_dec.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_inv_64_57_enc.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_subreg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_subreg_ext.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/sha2.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/sha2_pad.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_adapter_reg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_adapter_sram.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_cmd_intg_chk.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_data_integ_dec.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_data_integ_enc.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_err.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_err_resp.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_fifo_sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_rsp_intg_gen.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_socket_1n.sv">>raptor_tcl.tcl
    ##vary design to design
