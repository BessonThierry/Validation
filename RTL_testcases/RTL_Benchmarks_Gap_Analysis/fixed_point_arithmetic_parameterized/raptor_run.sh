...
design="fixed_point_arithmetic_parameterized"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/qadd.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/qdiv.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/qmult.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/qtwosComp.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module qmult">>raptor_tcl.tcl 
