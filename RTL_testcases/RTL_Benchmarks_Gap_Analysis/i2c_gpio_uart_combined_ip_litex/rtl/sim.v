...
module sim (
	...
	output reg  [31:0] gpio_oe='b0,
	output reg  [31:0] gpio_o='b0,
...
assign builder_csr_bankarray_csrbank3_load0_w = main_timer_load_storage[31:0];
assign builder_csr_bankarray_csrbank3_reload0_w = main_timer_reload_storage[31:0];
assign builder_csr_bankarray_csrbank3_en0_w = main_timer_en_storage;
assign builder_csr_bankarray_csrbank3_update_value0_w = main_timer_update_value_storage;
assign builder_csr_bankarray_csrbank3_value_w = main_timer_value_status[31:0];
assign main_timer_value_we = builder_csr_bankarray_csrbank3_value_we;
...
assign main_timer_status_we = builder_csr_bankarray_csrbank3_ev_status_we;
...
assign main_timer_pending_we = builder_csr_bankarray_csrbank3_ev_pending_we;
assign main_timer_zero2 = main_timer_enable_storage;
assign builder_csr_bankarray_csrbank3_ev_enable0_w = main_timer_enable_storage;
assign builder_csr_bankarray_csrbank4_sel = (builder_csr_bankarray_interface4_bank_bus_adr[13:9] == 3'd5);
assign main_uart_rxtx_r = builder_csr_bankarray_interface4_bank_bus_dat_w[7:0];
always @(*) begin
	main_uart_rxtx_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank4_sel & (builder_csr_bankarray_interface4_bank_bus_adr[8:0] == 1'd0))) begin
		main_uart_rxtx_we <= (~builder_csr_bankarray_interface4_bank_bus_we);
	end
end
always @(*) begin
	main_uart_rxtx_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank4_sel & (builder_csr_bankarray_interface4_bank_bus_adr[8:0] == 1'd0))) begin
		main_uart_rxtx_re <= builder_csr_bankarray_interface4_bank_bus_we;
	end
end
...
assign builder_csr_bankarray_csrbank4_txfull_w = main_uart_txfull_status;
assign main_uart_txfull_we = builder_csr_bankarray_csrbank4_txfull_we;
assign builder_csr_bankarray_csrbank4_rxempty_w = main_uart_rxempty_status;
assign main_uart_rxempty_we = builder_csr_bankarray_csrbank4_rxempty_we;
always @(*) begin
	main_uart_status_status <= 2'd0;
	main_uart_status_status[0] <= main_uart_tx0;
	main_uart_status_status[1] <= main_uart_rx0;
end
assign builder_csr_bankarray_csrbank4_ev_status_w = main_uart_status_status[1:0];
assign main_uart_status_we = builder_csr_bankarray_csrbank4_ev_status_we;
always @(*) begin
	main_uart_pending_status <= 2'd0;
	main_uart_pending_status[0] <= main_uart_tx1;
	main_uart_pending_status[1] <= main_uart_rx1;
end
assign builder_csr_bankarray_csrbank4_ev_pending_w = main_uart_pending_status[1:0];
assign main_uart_pending_we = builder_csr_bankarray_csrbank4_ev_pending_we;
assign main_uart_tx2 = main_uart_enable_storage[0];
assign main_uart_rx2 = main_uart_enable_storage[1];
assign builder_csr_bankarray_csrbank4_ev_enable0_w = main_uart_enable_storage[1:0];
assign builder_csr_bankarray_csrbank4_txempty_w = main_uart_txempty_status;
assign main_uart_txempty_we = builder_csr_bankarray_csrbank4_txempty_we;
assign builder_csr_bankarray_csrbank4_rxfull_w = main_uart_rxfull_status;
assign main_uart_rxfull_we = builder_csr_bankarray_csrbank4_rxfull_we;
...
always @(posedge sys_clk_1) begin
	...
	if (builder_csr_bankarray_csrbank3_load0_re) begin
		main_timer_load_storage[31:0] <= builder_csr_bankarray_csrbank3_load0_r;
	end
	main_timer_load_re <= builder_csr_bankarray_csrbank3_load0_re;
	if (builder_csr_bankarray_csrbank3_reload0_re) begin
		main_timer_reload_storage[31:0] <= builder_csr_bankarray_csrbank3_reload0_r;
	end
	main_timer_reload_re <= builder_csr_bankarray_csrbank3_reload0_re;
	if (builder_csr_bankarray_csrbank3_en0_re) begin
		main_timer_en_storage <= builder_csr_bankarray_csrbank3_en0_r;
	end
	main_timer_en_re <= builder_csr_bankarray_csrbank3_en0_re;
	if (builder_csr_bankarray_csrbank3_update_value0_re) begin
		main_timer_update_value_storage <= builder_csr_bankarray_csrbank3_update_value0_r;
	end
	main_timer_update_value_re <= builder_csr_bankarray_csrbank3_update_value0_re;
	main_timer_value_re <= builder_csr_bankarray_csrbank3_value_re;
	main_timer_status_re <= builder_csr_bankarray_csrbank3_ev_status_re;
	if (builder_csr_bankarray_csrbank3_ev_pending_re) begin
		main_timer_pending_r <= builder_csr_bankarray_csrbank3_ev_pending_r;
	end
	main_timer_pending_re <= builder_csr_bankarray_csrbank3_ev_pending_re;
	if (builder_csr_bankarray_csrbank3_ev_enable0_re) begin
		main_timer_enable_storage <= builder_csr_bankarray_csrbank3_ev_enable0_r;
	end
	main_timer_enable_re <= builder_csr_bankarray_csrbank3_ev_enable0_re;
	...
	if (builder_csr_bankarray_csrbank4_sel) begin
		case (builder_csr_bankarray_interface4_bank_bus_adr[8:0])
			1'd0: begin
				builder_csr_bankarray_interface4_bank_bus_dat_r <= main_uart_rxtx_w;
			end
			1'd1: begin
	...
	main_uart_txfull_re <= builder_csr_bankarray_csrbank4_txfull_re;
	main_uart_rxempty_re <= builder_csr_bankarray_csrbank4_rxempty_re;
	main_uart_status_re <= builder_csr_bankarray_csrbank4_ev_status_re;
	if (builder_csr_bankarray_csrbank4_ev_pending_re) begin
		main_uart_pending_r[1:0] <= builder_csr_bankarray_csrbank4_ev_pending_r;
	end
	main_uart_pending_re <= builder_csr_bankarray_csrbank4_ev_pending_re;
	if (builder_csr_bankarray_csrbank4_ev_enable0_re) begin
		main_uart_enable_storage[1:0] <= builder_csr_bankarray_csrbank4_ev_enable0_r;
	end
	main_uart_enable_re <= builder_csr_bankarray_csrbank4_ev_enable0_re;
	main_uart_txempty_re <= builder_csr_bankarray_csrbank4_txempty_re;
	main_uart_rxfull_re <= builder_csr_bankarray_csrbank4_rxfull_re;
	if (sys_rst) begin
...
//------------------------------------------------------------------------------
// Memory mem: 6097-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-02-03 14:28:55.
//------------------------------------------------------------------------------
