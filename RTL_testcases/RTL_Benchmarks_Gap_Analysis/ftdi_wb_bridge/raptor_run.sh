...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ftdi_if.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ftdi_sync.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module ftdi_if">>raptor_tcl.tcl 
