...
design="i2c_gpio_uart_axilite_combined_ip_litex"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/picorv32.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sim.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module sim">>raptor_tcl.tcl 
