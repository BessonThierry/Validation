...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_include_path ./rtl/verilog/area_opt/">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_library_path ./rtl/verilog/area_opt/">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_library_ext .v .sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/verilog/area_opt/key_sel.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/verilog/area_opt/$design.v">>raptor_tcl.tcl
    ##vary design to design
