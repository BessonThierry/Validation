...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/CLA_fixed.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/divider_dshift.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/shifter.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module divider_dshift">>raptor_tcl.tcl 
