...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_package.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/key_expander.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes128_fast.vhd">>raptor_tcl.tcl
    
    ##vary design to design

    echo "set_top_module aes128_fast">>raptor_tcl.tcl 
